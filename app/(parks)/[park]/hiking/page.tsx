...
export default function HikingPage() {
  ...
  return (
    <div className="sw" style={{ paddingBottom:'4rem' }}>
      ...
      <div className="eye">Hiking Trails · {park.shortName}</div>
      <h1 className="stitle">🥾 Hiking Trails</h1>
      <p className="ssub">Trails are loaded from NPS and OpenStreetMap data. Select difficulty and use type to filter.</p>
      ...
      <div style={{ background:'rgba(74,173,188,.06)', border:'1px solid rgba(74,173,188,.15)',
        ...
        <div style={{ fontFamily:'var(--fd)', fontSize:'1.1rem', fontWeight:700, marginBottom:'.5rem' }}>
          Hiking Trails Map — {park.shortName}
        </div>
        <div style={{ fontSize:'.84rem', color:'var(--granite)', lineHeight:1.7, marginBottom:'1.25rem', maxWidth:480, margin:'0 auto .75rem' }}>
          Trails are loaded from NPS and OpenStreetMap data. Select difficulty and use type to filter. Data for {park.shortName} loads from NPS and third-party sources.
