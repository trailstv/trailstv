...
export default function WildlifePage() {
  ...
  return (
    <div className="sw" style={{ paddingBottom:'4rem' }}>
      ...
      <div className="eye">Wildlife Viewing · {park.shortName}</div>
      <h1 className="stitle">🦅 Wildlife Viewing</h1>
      <p className="ssub">Prime wildlife viewing locations, species guides, and best times to visit.</p>
      ...
      <div style={{ background:'rgba(74,173,188,.06)', border:'1px solid rgba(74,173,188,.15)',
        ...
        <div style={{ fontFamily:'var(--fd)', fontSize:'1.1rem', fontWeight:700, marginBottom:'.5rem' }}>
          Wildlife Viewing Map — {park.shortName}
        </div>
        <div style={{ fontSize:'.84rem', color:'var(--granite)', lineHeight:1.7, marginBottom:'1.25rem', maxWidth:480, margin:'0 auto .75rem' }}>
          Prime wildlife viewing locations, species guides, and best times to visit. Data for {park.shortName} loads from NPS and third-party sources.
