...
export default function MtbPage() {
  ...
  return (
    <div className="sw" style={{ paddingBottom:'4rem' }}>
      ...
      <div className="eye">Mountain Biking · {park.shortName}</div>
      <h1 className="stitle">🚵 Mountain Biking</h1>
      <p className="ssub">MTB-legal routes sourced from OpenStreetMap and IMBA trail data.</p>
      ...
      <div style={{ background:'rgba(74,173,188,.06)', border:'1px solid rgba(74,173,188,.15)',
        ...
        <div style={{ fontFamily:'var(--fd)', fontSize:'1.1rem', fontWeight:700, marginBottom:'.5rem' }}>
          Mountain Biking Map — {park.shortName}
        </div>
        <div style={{ fontSize:'.84rem', color:'var(--granite)', lineHeight:1.7, marginBottom:'1.25rem', maxWidth:480, margin:'0 auto .75rem' }}>
          MTB-legal routes sourced from OpenStreetMap and IMBA trail data. Data for {park.shortName} loads from NPS and third-party sources.
