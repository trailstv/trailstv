  ...
  const activities = [
    {
      ...
      img:   '/assets/activity-camping.jpg',
      alt:   'Camping at Lake Tahoe — tent under pine trees with starry sky',
      ...
      cta:  'Check Campsite Availability →',
      ctaHref: '/campsites',
      moreHref: 'https://www.recreation.gov/gateways/2025',
      moreLabel: 'Recreation.gov',
    },
    {
      id:    'hiking',
      icon:  '🥾',
      ...
      img:   '/assets/activity-hiking.jpg',
      alt:   'Hiking trail in Lake Tahoe with mountain views',
      ...
      cta:  'Plan a Hike →',
      ctaHref: '/trails',
      moreHref: 'https://tahoeoutdoorstv.com/category/hiking/',
      moreLabel: 'More on TahoeOutdoorsTV',
    },
    {
      id:    'mtb',
      icon:  '🚵',
      ...
      img:   '/assets/activity-mtb.jpg',
      alt:   'Mountain biking singletrack trail in the Sierra Nevada',
      ...
      cta:  'Plan a Ride →',
      ctaHref: '/plan',
      moreHref: 'https://tahoeoutdoorstv.com/category/mountain-biking/',
      moreLabel: 'More on TahoeOutdoorsTV',
    },
    {
      id:    'kayaking',
      ...
      img:   '/assets/activity-kayaking.jpg',
      alt:   'Kayaking on Lake Tahoe with crystal-clear turquoise water',
      ...
      cta:  'Plan a Paddle →',
      ctaHref: '/plan',
      moreHref: 'https://tahoeoutdoorstv.com/category/kayaking/',
      moreLabel: 'More on TahoeOutdoorsTV',
    },
    {
      id:    'skiing',
      ...
      img:   '/assets/activity-skiing.jpg',
      alt:   'Skiing powder at Lake Tahoe with mountain views',
      ...
      cta:  'Plan a Ski Trip →',
      ctaHref: '/plan',
      moreHref: 'https://visitlaketahoe.com/',
      moreLabel: 'visitlaketahoe.com',
    },
    {
      id:    'boating',
      icon:  '⛵',
      ...
      img:   '/assets/activity-boating.jpg',
      alt:   'Boating on Lake Tahoe in summer sunshine',
      ...
      cta:  'Plan Water Day →',
      ctaHref: '/plan',
      moreHref: 'https://visitlaketahoe.com/things-to-do/boat-tours/',
      moreLabel: 'visitlaketahoe.com',
    },
  ];
  ...
  return (
    <>
      ...
      <section className="sw">
        ...
        <h2 className="stitle">Six Ways to<br/><span style={{ color:'var(--glacial)' }}>Experience Tahoe</span></h2>
      ...
      {activities.map((act, i) => {
        const reverse = i % 2 !== 0;
        return (
          <section key={act.id} style={{
            borderTop: '1px solid var(--cborder)',
            background: i % 2 === 0 ? 'transparent' : 'rgba(9,20,32,.4)',
          }}>
            <div className="sw" style={{ paddingTop:'3rem', paddingBottom:'3rem' }}>
              <div style={{
                display: 'grid',
                ...
                {/* Image */}
                <div style={{ direction:'ltr', position:'relative', borderRadius:12, overflow:'hidden', aspectRatio:'16/9', background:'rgba(13,27,42,.8)' }}>
                  <img
                    src={act.img}
                    alt={act.alt}
                    ...
                    onError={(e) => { (e.target as HTMLImageElement).style.display = 'none'; }}
                  />
                  <div style={{ position:'absolute', top:'1rem', left:'1rem', fontSize:'2rem' }}>{act.icon}</div>
                </div>

                {/* Content */}
                <div style={{ direction:'ltr' }}>
                  <div className="eye">{act.sub}</div>
                  <h3 style={{ fontFamily:'var(--fd)', fontSize:'clamp(1.4rem,2.5vw,2.2rem)', fontWeight:900, marginBottom:'.5rem', lineHeight:1.1 }}>
                    {act.title}
                  </h3>
                  ...
                  {act.trails.length > 0 && (
                    <div style={{ marginBottom:'1rem' }}>
                      {act.trails.map(t => (
                        <div key={t.name} style={{ display:'flex', justifyContent:'space-between', padding:'5px 0', borderBottom:'1px solid rgba(74,173,188,.07)', fontSize:'.78rem' }}>
                  ...
                  <div style={{ display:'flex', flexWrap:'wrap', gap:'.4rem', marginBottom:'1.25rem' }}>
                    {act.links.map(l => (
                      <a key={l.label} href={l.href} target="_blank" rel="noopener noreferrer"
                         style={{ fontSize:'.72rem', padding:'4px 10px', borderRadius:6, background:'rgba(74,173,188,.08)', border:'1px solid rgba(74,173,188,.18)', color:'var(--glacial)', textDecoration:'none', transition:'all .2s' }}>
                        {l.label}
                      </a>
                    ))}
                  </div>
        ...
        <div className="sw" style={{ paddingTop:'2.5rem', paddingBottom:'2.5rem' }}>
          <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:'3rem', alignItems:'center' }}>
            <div>
              ...
              <h2 className="stitle" style={{ fontSize:'clamp(1.4rem,2.5vw,2rem)', marginBottom:'.75rem' }}>Find Your Campsite</h2>
            ...
            <div style={{ display:'flex', flexDirection:'column', gap:'.5rem' }}>
              {topCamps.map(c => {
                ...
                return (
                  <Link key={c.id} href="/campsites" style={{ display:'flex', justifyContent:'space-between', alignItems:'center', padding:'.5rem .85rem', background:'rgba(13,27,42,.6)', borderRadius:8, fontSize:'.8rem', textDecoration:'none', color:'var(--snow)', transition:'background .2s' }}>
