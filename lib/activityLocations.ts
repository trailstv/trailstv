...
export const ACTIVITY_MAPS: Record<string, ActivityMeta> = {
  ...
  camping: {
    ...
    pins: [
      { id:'dlbliss',   name:'D.L. Bliss State Park',          lat:38.9695, lng:-120.1035, type:'campsite', shore:'west', desc:'168 sites · Beach access · ReserveCalifornia', fee:'$35/night', url:'https://reservecalifornia.com/park/637' },
      { id:'eaglepoint',name:'Eagle Point — Emerald Bay',      lat:38.9540, lng:-120.1060, type:'campsite', shore:'west', desc:'97 sites · Bay views · ReserveCalifornia',    fee:'$35/night', url:'https://reservecalifornia.com/park/641' },
      { id:'sugarpine', name:'Sugar Pine Point',               lat:39.0418, lng:-120.1120, type:'campsite', shore:'west', desc:'175 sites · Year-round · ReserveCalifornia',  fee:'$35/night', url:'https://www.parks.ca.gov/?page_id=510' },
      ...
      { id:'tahoesra',  name:'Tahoe State Recreation Area',    lat:39.1720, lng:-120.1465, type:'campsite', shore:'north',desc:'23 sites · Lakeside · ReserveCalifornia',      fee:'$35/night', url:'https://www.parks.ca.gov/?page_id=504' },
      { id:'lakeforest',name:'Lake Forest Campground',         lat:39.1778, lng:-120.1342, type:'campsite', shore:'north',desc:'20 sites · First-come · Boat ramp',            fee:'$25/night', url:'https://www.tcpud.org/parks-facilities/facilities-parks-and-rentals/lake-forest-campground' },
      { id:'kaspian',   name:'Kaspian Campground',             lat:39.1138, lng:-120.1548, type:'campsite', shore:'north',desc:'10 sites · Tent-only · Lake views',            fee:'$27/night', url:'https://www.recreation.gov/camping/campgrounds/232875' },
      ...
      { id:'campbythelake',name:'Campground by the Lake',      lat:38.9274, lng:-119.9742, type:'campsite', shore:'south',desc:'170 sites · RV hookups · City of SLT',         fee:'$39/night', url:'https://www.cityofslt.gov/270/Campground-by-the-Lake' },
  ...
  climbing: {
    ...
    center: [38.95, -120.10], zoom: 10,
    desc: 'World-class granite crags, volcanic tuff, and bouldering — sport, trad, and top-rope within an hour of the lake.',
    pins: [
      // ── Signature Crags ──────────────────────────────────────────────────
      { id:'lovers-leap',     name:'Lovers Leap',                  lat:38.7943, lng:-120.0388, type:'trailhead', shore:'south', desc:'The signature Tahoe-area crag. 100+ routes on perfect granite slabs and faces · 5.5–5.13c · Sport & trad · Walk-off descents · Roadside parking · Open year-round · 45 min from SLT', difficulty:'All levels — 5.5 to 5.13', url:'https://www.mountainproject.com/area/105907562/lovers-leap' },
      { id:'donner-summit',   name:'Donner Summit',                lat:39.3212, lng:-120.3280, type:'trailhead', shore:'north', desc:'Historic California granite climbed since the 1930s · 200+ routes across dozens of formations · All grades · South-facing — climbable earlier in season · 30 min from Tahoe City', difficulty:'All levels — 5.4 to 5.13', url:'https://www.mountainproject.com/area/105833381/donner-summit' },
      { id:'luther-spires',   name:'Luther Spires',                lat:38.7980, lng:-119.9620, type:'trailhead', shore:'south', desc:'Bolt-protected sport climbing on sunny south-facing granite · Short 10 min approach · Beginner and intermediate friendly · Multiple walls · Year-round · Popular for learning to lead outdoors', difficulty:'Beginner–Intermediate 5.6–5.11' },
      { id:'phantom-spires',  name:'Phantom Spires',               lat:38.8862, lng:-120.0478, type:'trailhead', shore:'south', desc:'South shore hidden gem · Quality granite sport crag · Bolted routes in the 5.8–5.11 range · Quieter than Lovers Leap · 30 min from SLT · Short approach through pine forest', difficulty:'Intermediate 5.8–5.11' },
      { id:'eagle-creek',     name:'Eagle Creek Canyon',           lat:38.9538, lng:-120.1093, type:'trailhead', shore:'west',  desc:'West shore multi-pitch granite · Mix of trad and sport · Near Eagle Falls · Longer adventure routes in a stunning canyon setting · Moderate to hard grades', difficulty:'Intermediate–Expert 5.7–5.12' },
      { id:'tahoe-crags',     name:'Tahoe Crags',                  lat:39.2540, lng:-120.0330, type:'trailhead', shore:'north', desc:'North shore granite sport crag · Bolted moderate routes · Short approaches · Views of Lake Tahoe from the top · Less crowded than south shore crags', difficulty:'Moderate 5.7–5.11' },
      { id:'sugarloaf',       name:'Sugarloaf Buttress',           lat:38.8752, lng:-120.0295, type:'trailhead', shore:'south', desc:'Classic south shore trad crag · Multi-pitch routes on clean granite · 5.5–5.10 range · Perfect for trad leaders stepping up to longer routes · Moderate approach', difficulty:'Moderate 5.5–5.10' },
      { id:'echo-summit-crag',name:'Echo Summit Crags',            lat:38.8083, lng:-120.0360, type:'trailhead', shore:'south', desc:'Roadside granite crags at Echo Summit · Quick access from Hwy 50 · Variety of sport and trad routes · Good early season crag — south-facing and dries fast', difficulty:'All levels 5.6–5.11' },
      // ── Volcanic ─────────────────────────────────────────────────────────
      { id:'cave-rock',       name:'Cave Rock',                    lat:39.0332, lng:-119.9592, type:'trailhead', shore:'east',  desc:'Unique overhanging volcanic tuff · East shore lakeshore location · Pocket pulling on steep faces · 5.11–5.13 · Culturally significant to Washoe Tribe — seasonal closures apply', difficulty:'Hard — 5.11–5.13', note:'Washoe Tribal site — check for seasonal closures before visiting', url:'https://www.mountainproject.com/area/105800649/cave-rock' },
      // ── Bouldering ───────────────────────────────────────────────────────
      { id:'dlbliss-boulders',name:'D.L. Bliss Bouldering',        lat:38.9695, lng:-120.1030, type:'spot', shore:'west',  desc:'Beach-access granite boulders at D.L. Bliss State Park · V0–V6 · No approach · Free to session after park entry · Great warm-up spot before heading to west shore crags', difficulty:'V0–V6' },
      { id:'tunnel-rock',     name:'Tunnel Rock Bouldering',       lat:39.3200, lng:-120.3200, type:'spot', shore:'north', desc:'Roadside granite bouldering near Donner Summit · V0–V8 · Easy roadside access · Good variety of problems on quality rock · Pairs well with Donner Summit sport climbing', difficulty:'V0–V8' },
      { id:'shakespeare-rock',name:'Shakespeare Rock',             lat:38.8050, lng:-120.0600, type:'spot', shore:'south', desc:'Beginner top-rope area on solid south shore granite · Great first crag for new climbers · 5.5–5.9 range · Easy to set top ropes · Friendly atmosphere · 20 min from SLT', difficulty:'Beginner 5.5–5.9' },
      { id:'emerald-bay-boulders', name:'Emerald Bay Boulders',    lat:38.9520, lng:-120.1010, type:'spot', shore:'west',  desc:'Granite bouldering problems above Emerald Bay · V0–V5 · Scenic setting above the lake · Combine with a Vikingsholm hike for a full day · Low-key and uncrowded', difficulty:'V0–V5' },
      // ── Gear & Beta ──────────────────────────────────────────────────────
      { id:'alpenglow-climb', name:'Alpenglow Sports',             lat:39.3275, lng:-120.1837, type:'rental', shore:'north', desc:'Best climbing shop near Tahoe · Truckee · Full rack of shoes, harnesses, and hardware for rent or purchase · Expert route beta · Guidebooks for all Tahoe-area crags', url:'https://alpenglowsports.com' },
      { id:'rei-climb',       name:'REI — South Lake Tahoe',       lat:38.9310, lng:-119.9780, type:'rental', shore:'south', desc:'Climbing gear and rentals · South shore · Full outfitter · Gear advice from knowledgeable staff · Shoes, harnesses, helmets, and chalk available', url:'https://www.rei.com' },
    ],
  },
};
