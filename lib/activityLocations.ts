...
export const ACTIVITY_MAPS: Record<string, ActivityMeta> = {
  ...
  camping: {
    ...
    pins: [
      ...
      { id:'campbythelake',name:'Campground by the Lake',      lat:38.9274, lng:-119.9742, type:'campsite', shore:'south',desc:'170 sites · RV hookups · City of SLT',         fee:'$39/night', url:'https://www.recreation.gov/camping/campgrounds/232488' },
