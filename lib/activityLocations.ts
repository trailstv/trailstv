...
export const ACTIVITY_MAPS: Record<string, ActivityMeta> = {
  ...
  camping: {
    ...
    pins: [
      { id:'dlbliss',   name:'D.L. Bliss State Park',          lat:38.9695, lng:-120.1035, type:'campsite', shore:'west', desc:'168 sites · Beach access · ReserveCalifornia', fee:'$35/night', url:'https://www.reservecalifornia.com/CaliforniaWebHome/Facilities/AdvanceSearch.aspx?Keywords=D.L.+Bliss' },
      { id:'eaglepoint',name:'Eagle Point — Emerald Bay',      lat:38.9540, lng:-120.1060, type:'campsite', shore:'west', desc:'97 sites · Bay views · ReserveCalifornia',    fee:'$35/night', url:'https://www.reservecalifornia.com/CaliforniaWebHome/Facilities/AdvanceSearch.aspx?Keywords=Emerald+Bay' },
      { id:'sugarpine', name:'Sugar Pine Point',               lat:39.0418, lng:-120.1120, type:'campsite', shore:'west', desc:'175 sites · Year-round · ReserveCalifornia',  fee:'$35/night', url:'https://www.reservecalifornia.com/CaliforniaWebHome/Facilities/AdvanceSearch.aspx?Keywords=Sugar+Pine+Point' },
      ...
      { id:'tahoesra',  name:'Tahoe State Recreation Area',    lat:39.1720, lng:-120.1465, type:'campsite', shore:'north',desc:'23 sites · Lakeside · ReserveCalifornia',      fee:'$35/night', url:'https://www.reservecalifornia.com/CaliforniaWebHome/Facilities/AdvanceSearch.aspx?Keywords=Tahoe+State+Recreation' },
