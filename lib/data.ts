...
export const CAMPS_FALLBACK: Camp[] = [
  { id:'dlbliss', name:"D.L. Bliss State Park", lat:38.9695, lng:-120.1035, shore:'west', sites:168, available:18, limited:false, full:false, fee:35, hookups:false, pets:true, res:true, amenities:['Flush Toilets','Hot Showers','Dump Station','Beach Access','Bear Boxes'], desc:"One of Tahoe's most beloved campgrounds — reopened May 2026.", phone:'530-525-7277', url:'https://www.reservecalifornia.com/CaliforniaWebHome/Facilities/AdvanceSearch.aspx?Keywords=D.L.+Bliss', bookSystem:'ReserveCalifornia', img:'⛺', region:'CA State Parks · West Shore' },
  { id:'eaglepoint', name:"Emerald Bay — Eagle Point", lat:38.9540, lng:-120.1060, shore:'west', sites:97, available:4, limited:true, full:false, fee:35, hookups:false, pets:false, res:true, amenities:['Flush Toilets','Coin Showers','Fire Rings','Bear Boxes'], desc:"97-site campground inside Emerald Bay State Park.", phone:'530-541-3030', url:'https://www.reservecalifornia.com/CaliforniaWebHome/Facilities/AdvanceSearch.aspx?Keywords=Emerald+Bay', bookSystem:'ReserveCalifornia', img:'🏰', region:'CA State Parks · West Shore' },
  { id:'sugarpine', name:"Sugar Pine Point — General Creek", lat:39.0418, lng:-120.1120, shore:'west', sites:175, available:31, limited:false, full:false, fee:35, hookups:false, pets:true, res:true, amenities:['Flush Toilets','Showers','Fire Rings','Boat Ramp'], desc:"175 sites — one loop stays open year-round.", phone:'530-525-7982', url:'https://www.reservecalifornia.com/CaliforniaWebHome/Facilities/AdvanceSearch.aspx?Keywords=Sugar+Pine+Point', bookSystem:'ReserveCalifornia', img:'🌲', region:'CA State Parks · West Shore' },
